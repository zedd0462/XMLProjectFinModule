        ...
        <div class= "row h-100 my-5">
            ...
            <div class="col-6 border bg-white">
                <div class="my-3">
                    ...
                    <div class="row ">
                        <div class="col-3"></div>
                        <a  class="btn btn-primary col-6 my-1" href="tickets_user.php">Voir les tickets</a>
                        <div class="col-3"></div>
                        <div class="col-3"></div>
                        <a   class="btn btn-primary col-6 my-1" href="index.html">Réserver un siége</a >
                        <div class="col-3"></div>
                        <div class="col-3"></div>
